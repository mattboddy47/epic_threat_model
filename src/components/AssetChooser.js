...
export const AssetChooser = (props) => {
...
const selected = userAssets.some(userAsset => userAsset.asset_container === asset.name)

if (selected){
  asset.selected = selected;
}
asset.asset_containers.forEach(asset_container => {
    asset_container.selected = userAssets.some(userAsset => userAsset.name === asset_container.name);
})
